...
export default function Carousel({ id, images }) {
    return <div id="default-carousel" className="relative w-full" data-carousel="slide">
        ...
        <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
            {/* <!-- Item 1 --> */}
            {images.map(img => <div key={img} className="hidden duration-700 ease-in-out" data-carousel-item>
                <Image src={img || "images/carousel-1.svg"} fill className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt={`${id}  ${img.split("/").pop()}`} />
            </div>)}
        </div>
        {/* <!-- Slider indicators --> */}
